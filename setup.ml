...
(* OASIS_START *)
(* DO NOT EDIT (digest: e9c48dec00ae69386b701be2cfbd1653) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Cut-down Bigarray without UNIX dependency";
          description = None;
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "/v\157\150\238\208iC\195\197G\198\192V \238";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
